    ...
    <div style={{ maxWidth:560 }}>
      ...
      <div style={{ background:'#FFFFFF', borderRadius:14, boxShadow:'0 1px 3px rgba(0,0,0,.06),0 2px 8px rgba(0,0,0,.04)', padding:'1.25rem', marginBottom:'1rem', border:'none' }}>
        ...
        <button onClick={logout}
          style={{ width:'100%', padding:'10px', borderRadius:10, border:'none', background:'#F7F7F7', fontSize:13, fontWeight:500, cursor:'pointer', fontFamily:'inherit', color:'var(--tx)' }}>
          Sair desta conta
        </button>
      </div>
      ...
      <div style={{ background:'#FFFFFF', borderRadius:14, boxShadow:'0 1px 3px rgba(0,0,0,.06),0 2px 8px rgba(0,0,0,.04)', padding:'1.25rem', marginBottom:'1rem', border:'none' }}>
        ...
        <button onClick={async()=>{
          ...
          style={{ padding:'8px 16px', borderRadius:8, border:'none', background:'#F7F7F7', fontSize:12, cursor:'pointer', fontFamily:'inherit', color:'var(--tm)' }}>
          Exportar meus dados
        </button>
      </div>
