...
export default function DashboardNav({ planLabel, section, nome, planId, onMenuOpen, onNavigate, onLogout, onOpenPerfil, onOpenConfig, userId, answers, onOpenPlanos }) {
