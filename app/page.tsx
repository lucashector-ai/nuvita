...
// ═══════════════════════════════════════════════
// Médicos Parceiros — banner de confiança
// ═══════════════════════════════════════════════
function MedicosBanner() {
  return (
...
function IllustrationMedicos() {
  return (
    <svg width="280" height="280" viewBox="0 0 280 280" fill="none" style={{ maxWidth: '100%' }}>
      ...
      <circle cx="140" cy="140" r="120" stroke="rgba(34, 197, 94, 0.2)" strokeWidth="1" strokeDasharray="4 4" />
      ...
      <path d="M128 130 Q140 138 152 130" stroke="#22C55E" strokeWidth="3" strokeLinecap="round" fill="none" />

      {/* Jaleco/cruz médica */}
      <rect x="135" y="148" width="10" height="3" fill="#22C55E" />
      <rect x="138.5" y="144.5" width="3" height="10" fill="#22C55E" />

      {/* Linhas de credencial */}
      ...
      <text x="140" y="202" textAnchor="middle" fontSize="9" fontWeight="600" fill="#15803D" fontFamily="system-ui, sans-serif">
        CRM verificado
      </text>
      ...
      {/* Linhas conectando */}
      <path d="M74 128 Q82 130 90 132" stroke="#22C55E" strokeWidth="1.5" strokeDasharray="3 3" fill="none" opacity="0.5" />
      <path d="M190 132 Q200 130 210 128" stroke="#22C55E" strokeWidth="1.5" strokeDasharray="3 3" fill="none" opacity="0.5" />
